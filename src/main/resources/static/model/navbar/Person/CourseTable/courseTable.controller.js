(function () {
    ...
    TableCtrl.$inject = ['testService', '$scope', '$filter', 'toaster', 'StudentService'];

    function TableCtrl(testService, $scope, $filter, toaster, StudentService) {
        testService.test().then(function (userData) {
            ...
            $scope.dataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read: function (e) {
                        StudentService.findPersonInDetail($scope.condition).then(function (response) {
